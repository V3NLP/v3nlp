...
public class HitexSectionizerImpl extends BaseGateService implements SectionizerService {
	...
	/* (non-Javadoc)
	 * @see gov.va.vinci.v3nlp.services.SectionizerService#getDefaultSectionizerConfiguration()
	 */
	...
	/* (non-Javadoc)
	 * @see gov.va.vinci.v3nlp.services.SectionizerService#processPipeLine(java.lang.String, java.lang.String, gov.va.vinci.cm.Corpus)
	 */
	...
	/* (non-Javadoc)
	 * @see gov.va.vinci.v3nlp.services.SectionizerService#getAvailableSectionHeaders()
	 */
